  ...
  <div id="page-content">
      <div class="row justify-content-center m-0 text-center">
        <div class="col-md-12 p-0">
          ...
          <hr>
          <div class="addittions">
            <a href='admin.php' role='button' class='btn btn-lg btn-danger btn-inline-block text-uppercase mt-5 mb-4 p-4 w-25'>Go back to trainer list</a>
          </div>

            <?php   
            
            $user_info = $_GET['trainer_id'];
            $list = $Admin->search_trainer($user_info);
