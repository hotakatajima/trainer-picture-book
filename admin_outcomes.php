        ...
        <div class="col-md-12 p-0">
          ...
          <form action="admin_action.php" method="post">
            <div class="form-group mt-5">
                <div class="alert alert-danger w-50 mx-auto">Sorry, trainers you entered don't exist. Please search agein.</div>
                <input type="text" name="search" class="form-control w-25 d-inline p-3 mt-5" placeholder="Search trainer username or trainer address">
