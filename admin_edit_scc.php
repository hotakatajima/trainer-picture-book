<?php
    ...
    if(empty($_SESSION['login_id'])){
      ...
      $dis = $_GET['trainer_id'];
      $display = $Admin->display_onetrainers($dis);
    }
    ...
    <div class="row">
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
            <h5 class="card-title text-center">Edit a trainer</h5>
            <form action="admin_action.php" method="post" class="form-signin" enctype="multipart/form-data">
              ...
              <!-- <div class="form-label-group"> -->
                <input type="file" name="images" class="mt-3 ml-5" placeholder="Image" maxlength="100">
                <!-- <label for="trainerimage">Image</label> -->
              <!-- </div> -->

              <input type="hidden" name="id" value="<?php echo $dis ?>">
             
              <button class="btn btn-lg btn-primary btn-block text-uppercase mt-5" type="submit" name="admin_edit">Edit</button>
              <hr>
              <a href="admin.php" class="btn btn-lg btn-google btn-block text-uppercase">Go back to Admin</a>
            </form>
          </div>
        </div>
      </div>
